...
define region BL2_CODE_region        = mem:[from ((((0x08000000)) + ((0x0000)))) size ((0x18000))];
define region BL2_RAM_region         = mem:[from ((0x20040000)) size ((0x10000))];
...
place at address ((((((0x08000000)) + ((0x0000)))))) { readonly section .intvec };
