...
set s_icf_file=%appli_dir%\MDK-ARM\stm32h563xx.sct
set s_main="%appli_dir%\Inc\main.h"
) else (
set s_icf_file="%appli_dir%\MDK-ARM\Secure\stm32h563xx_s.sct"
set ns_icf_file="%appli_dir%\MDK-ARM\NonSecure\stm32h563xx_ns.sct"
