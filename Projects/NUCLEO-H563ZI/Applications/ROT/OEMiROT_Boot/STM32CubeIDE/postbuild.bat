...
::======================================================================================
set s_code_xml="%projectdir%\..\..\..\..\ROT_Provisioning\%bootpath%\Images\%project%_S_Code_Image.xml"
set ns_code_xml="%projectdir%\..\..\..\..\ROT_Provisioning\%bootpath%\Images\%project%_NS_Code_Image.xml"
set s_data_xml="%projectdir%\..\..\..\..\ROT_Provisioning\%bootpath%\Images\%project%_S_Data_Image.xml"
set ns_data_xml="%projectdir%\..\..\..\..\ROT_Provisioning\%bootpath%\Images\%project%_NS_Data_Image.xml"
set s_code_init_xml="%projectdir%\..\..\..\..\ROT_Provisioning\%bootpath%\Images\%project%_S_Code_Init_Image.xml"
set ns_code_init_xml="%projectdir%\..\..\..\..\ROT_Provisioning\%bootpath%\Images\%project%_NS_Code_Init_Image.xml"
set s_data_init_xml="%projectdir%\..\..\..\..\ROT_Provisioning\%bootpath%\Images\%project%_S_Data_Init_Image.xml"
set ns_data_init_xml="%projectdir%\..\..\..\..\ROT_Provisioning\%bootpath%\Images\%project%_NS_Data_Init_Image.xml"
...
:: ============================================================== Update %ns_ld_file% ================================================================
IF "%app_full_secure%" == "1" (goto :bypass_secure_sct_file_update)
