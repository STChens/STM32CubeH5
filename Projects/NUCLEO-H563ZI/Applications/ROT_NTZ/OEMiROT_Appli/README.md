...
### <b>Directory contents</b>
  ...
  - ROT_NTZ/OEMiROT_Appli/Src/com.c                                 UART low level interface
  - ROT_NTZ/OEMiROT_Appli/Src/loader.c                              System configuration before calling bootloader
  - ROT_NTZ/OEMiROT_Appli/Src/low_level_device.c                    Flash Low level device setting
  - ROT_NTZ/OEMiROT_Appli/Src/low_level_flash.c                     Secure Low level flash driver
  - ROT_NTZ/OEMiROT_Appli/Src/main.c                                Secure Main program
  - ROT_NTZ/OEMiROT_Appli/Src/stm32h5xx_it.c                        Secure Interrupt handlers
  - ROT_NTZ/OEMiROT_Appli/Src/system_stm32h5xx.c                    Secure STM32H5xx system clock configuration file
  - ROT_NTZ/OEMiROT_Appli/Inc/low_level_flash.h                     Secure Low level flash driver header file
  - ROT_NTZ/OEMiROT_Appli/Inc/main.h                                Secure Main program header file
  - ROT_NTZ/OEMiROT_Appli/Inc/partition_stm32h573xx.h               STM32H5xx Device System Configuration file
  - ROT_NTZ/OEMiROT_Appli/Inc/stm32h5xx_hal_conf.h                  Secure HAL Configuration file
  - ROT_NTZ/OEMiROT_Appli/Inc/stm32h5xx_it.h                        Secure Interrupt handlers header file
  - ROT_NTZ/OEMiROT_Appli/Secure_nsclib/appli_flash_layout.h        Flash layout header file
  - ROT_NTZ/OEMiROT_Appli/Binary                                    Application firmware image (application binary + MCUBoot header and metadata)
...
Then start provisioning process by running ROT_Provisioning/OEMiROT_NTZ/provisioning.bat or provisioning.sh, and follow its instructions.
