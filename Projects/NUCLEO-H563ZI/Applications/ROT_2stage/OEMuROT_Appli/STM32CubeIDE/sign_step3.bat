...
::=============================================================================================
::Generate FW image for enc signed bin and hex
::=============================================================================================

::update xml file [enc_sign]: set signature file signed by external tool (b64 encoded signature)
%python%%applicfg% xmlval -v %s_app_enc_sign_sig_b64_file% --string -n %fw_signature_xml_field% %s_code_xml% --vb >> %current_log_file% 2>>&1
if !errorlevel! neq 0 goto :error

::update xml file [enc_sign]: output file (to generated signed and ecrypted bin filie)
...
::update xml file [enc_sign]: output file (to generated signed and ecrypted hex filie)
...
::=============================================================================================
::Generate FW image for init signed hex file
::=============================================================================================

::update xml file [init_sign]: set signature file signed by external tool (b64 encoded signature)
%python%%applicfg% xmlval -v %s_app_init_sign_sig_b64_file% --string -n %fw_signature_xml_field% %s_code_init_xml% --vb >> %current_log_file% 2>>&1
if !errorlevel! neq 0 goto :error

::update xml file [init_sign]: output file
