...
#define FLASH_AREA_0_SIZE              0xBE000   /* Secure app image primary slot size */
...
#define FLASH_PARTITION_SIZE           0xBE000  /* Secure and Non Secure partition size */

#define FLASH_NS_PARTITION_SIZE        0x0  /* Non Secure partition size */

#define FLASH_S_PARTITION_SIZE         0xBE000   /* secure partition size */
