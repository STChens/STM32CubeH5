...
#define MCUBOOT_APP_IMAGE_NUMBER 1      /* 1: must be 1 for NTZ application */
...
#define FLASH_AREA_4_SIZE               (FLASH_DATA_PARTITION_SIZE)
...
#define FLASH_AREA_0_SIZE               (FLASH_APP_PARTITION_SIZE)
...
#define FLASH_AREA_2_OFFSET             (FLASH_AREA_BEGIN_OFFSET + FLASH_AREA_4_SIZE + \
                                         FLASH_AREA_0_SIZE)
#define FLASH_AREA_2_SIZE               (FLASH_APP_PARTITION_SIZE)
...
#define FLASH_AREA_6_SIZE               (FLASH_DATA_PARTITION_SIZE)
...
#define  FLASH_PRIMARY_DATA_DEV_NAME        Driver_FLASH0
