...
::=================================================================================================
REM Run script for "App Signing Part 2"
::=================================================================================================
@ECHO OFF
...
::=============================================================================================
openssl pkeyutl -sign -inkey %provisioningdir%\%bootpath%\keys\OEMuRoT_Authentication_S.pem -in %s_app_init_sign_digest_file%  -out %s_app_init_sign_sig_file% >> %current_log_file% 2>>&1
openssl pkeyutl -sign -inkey %provisioningdir%\%bootpath%\keys\OEMuRoT_Authentication_S.pem -in %s_app_enc_sign_digest_file%  -out %s_app_enc_sign_sig_file% >> %current_log_file% 2>>&1
