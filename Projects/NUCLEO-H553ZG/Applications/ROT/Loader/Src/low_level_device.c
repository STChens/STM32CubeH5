...
#if defined (OEMUROT_ENABLE)  /* Add the area for OEMuROT FW and Data download */
  { FLASH_AREA_OEMuROT_FW_OFFSET, FLASH_AREA_OEMuROT_FW_OFFSET + FLASH_AREA_OEMuROT_FW_SIZE - 1},
  { FLASH_AREA_OEMuROT_DATA_OFFSET, FLASH_AREA_OEMuROT_DATA_OFFSET + FLASH_AREA_OEMuROT_DATA_SIZE - 1},
#endif
#if (MCUBOOT_S_DATA_IMAGE_NUMBER == 1)
