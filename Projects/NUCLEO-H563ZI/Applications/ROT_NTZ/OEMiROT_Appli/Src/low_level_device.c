...
static struct flash_range access_vect[] =
{
  ...
  { IMAGE_SECONDARY_PARTITION_OFFSET, IMAGE_SECONDARY_PARTITION_OFFSET + FLASH_PARTITION_SIZE - 1},
...
#else
  { IMAGE_PRIMARY_PARTITION_OFFSET, IMAGE_PRIMARY_PARTITION_OFFSET + FLASH_PARTITION_SIZE - 1},
#if defined (OEMUROT_ENABLE)
...
{
  { IMAGE_SECONDARY_PARTITION_OFFSET, IMAGE_SECONDARY_PARTITION_OFFSET + FLASH_PARTITION_SIZE - 1},
  { IMAGE_PRIMARY_PARTITION_OFFSET + FLASH_PARTITION_SIZE - 32, IMAGE_PRIMARY_PARTITION_OFFSET + FLASH_PARTITION_SIZE - 16 - 1},
#if defined (OEMUROT_ENABLE)
  { OEMIROT_AREA_2_OFFSET, OEMIROT_AREA_2_OFFSET + OEMIROT_AREA_2_SIZE - 1},
