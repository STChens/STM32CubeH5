...
set "flash_layout=%cube_fw_path%\Projects\NUCLEO-H563ZI\%oemirot_oemurot_boot_path_stage2_project%\Inc\flash_layout.h"
set flash_layout=%flash_layout:"=%

:: Environment variable used to know if the firmware image is full secure or not
set OEMiROT_config=".\Config\OEMiROT_Config.xml"
...
echo =====   %oemirot_oemurot_boot_path_app_project%
...
if not exist %cube_fw_path%\Projects\NUCLEO-H563ZI\%oemirot_oemurot_boot_path_app_project% (
echo =====
echo ===== Wrong Boot path: %oemirot_oemurot_boot_path_app_project%
...
echo        Select OEMiROT_Config.xml(Default path is \ROT_Provisioning\OEMiROT_OEMuROT\Config\OEMiROT_Config.xml)
...
echo        Open the OEMiROT_Boot and OEMuROT_Boot project with preferred toolchain and rebuild all files.
echo        At this step the project is configured for OEMiROT_OEMuROT boot path
echo        Press any key to continue...
if [%1] neq [AUTO] pause >nul
echo;
::update xml file
...
echo        (NUCLEO-H563ZI: set SW1 to position 0)
echo        Press any key to continue...
echo;
if [%1] neq [AUTO] pause >nul
...
echo        (NUCLEO-H563ZI: set SW1 to position 1)
echo        Press any key to continue...
echo;
if [%1] neq [AUTO] pause >nul
