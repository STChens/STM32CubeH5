...
typedef HAL_StatusTypeDef (*Ymodem_DataPktCB_t)(uint8_t*, uint32_t, uint32_t);
typedef HAL_StatusTypeDef (*Ymodem_HeaderPktCB_t)(uint32_t uFlashDestination, uint32_t uFileSize);
