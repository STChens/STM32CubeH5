...
::=================================================================================================
REM Run script for "OEMiROT Signing Part 1"
::=================================================================================================
@ECHO OFF
...
::=============================================================================================
::image xml configuration files (pre-sign configuration)
::=============================================================================================
set s_code_xml="%provisioningdir%\%bootpath%\Images\%project%_Code_Image_presign.xml"
set s_code_init_xml="%provisioningdir%\%bootpath%\Images\%project%_Code_Init_Image_presign.xml"
...
%python%%applicfg% xmlval -v %s_app_enc_sign_hex_xml_field% --string -n %fw_digst_out_bin_xml_field% %s_code_xml% --vb >> %current_log_file% 2>>&1
if !errorlevel! neq 0 goto :error
