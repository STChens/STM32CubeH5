...
set oemurot_sign_script="%oemurot_dir%\STM32CubeIDE\sign.bat"
...
set "command=%python%%applicfg% linker --layout %preprocess_bl2_file% -m RE_FLASH_LOADER_SIZE -n LOADER_CODE_SIZE %loader_ld_file% --vb >> %current_log_file% 2>&1"
%command%
IF !errorlevel! NEQ 0 goto :error
