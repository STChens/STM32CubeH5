...
/*int main(void) */
{
  ...
  GPIOA->SECCFGR = 0xFFFFFFFF;
#endif /* GPIOA */
#if defined(GPIOB)
  __HAL_RCC_GPIOB_CLK_ENABLE();
  GPIOB->SECCFGR = 0xFFFFFFFF;
#endif /* GPIOB */
#if defined(GPIOC)
  __HAL_RCC_GPIOC_CLK_ENABLE();
  GPIOC->SECCFGR = 0xFFFFFFFF;
#endif /* GPIOC */
#if defined(GPIOD)
  __HAL_RCC_GPIOD_CLK_ENABLE();
  GPIOD->SECCFGR = 0xFFFFFFFF;
#endif /* GPIOD */
#if defined(GPIOE)
  __HAL_RCC_GPIOE_CLK_ENABLE();
  GPIOE->SECCFGR = 0xFFFFFFFF;
#endif /* GPIOE */
#if defined(GPIOG)
  __HAL_RCC_GPIOG_CLK_ENABLE();
  GPIOG->SECCFGR = 0xFFFFFFFF;
#endif /* GPIOG */
#if defined(GPIOH)
  __HAL_RCC_GPIOH_CLK_ENABLE();
  GPIOH->SECCFGR = 0xFFFFFFFF;
#endif /* GPIOH */
